class MembershipSettingsController < AuthenticatedController
  ...
  # Reminder cadence is not here: it lives on each reminder's own settings row and is edited on
  # the Reminders page.
  def membership_setting_params
    params.expect(membership_setting: %i[reactivation_grace_period_months
