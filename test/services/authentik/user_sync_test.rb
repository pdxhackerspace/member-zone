...
module Authentik
  class UserSyncTest < ActiveSupport::TestCase
    ...
    test 'sync_to_authentik sends inactive users as active when setting enabled' do
      ...
      user = users(:two)
      user.update_columns(authentik_id: 'authentik-inactive-active-test', active: false, membership_state: 'inactive_member')
    ...
    test 'sync_to_authentik sends inactive users as inactive when setting disabled' do
      ...
      user = users(:two)
      user.update_columns(authentik_id: 'authentik-inactive-inactive-test', active: false, membership_state: 'inactive_member')
